...
class PSDLiveUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.sld_ymin.setValue(-100)

        self.sld_ymax = QSlider(Qt.Horizontal)
        self.sld_ymax.setMinimum(-100)
        self.sld_ymax.setMaximum(20)
        ...
        self.sld_ymax.setValue(20)

        self.lbl_ymin_val = QLabel("-100 dB")
        self.lbl_ymax_val = QLabel("20 dB")
