# Skill Registry — SDR-SpectrumMonitoring-Sensor
...
| `esp-idf` | Trigger: ESP-IDF, ESP32, espressif, idf.py, FreeRTOS ESP, embedded C, xtensa, GPIO config, Wi-Fi station, NVS flash, SPI flash, I2C/SPI/UART driver, OTA update, BLE, NimBLE. Programming API for ESP-IDF v6.0.2 on ESP32. | user | `/home/javastral/.config/opencode/skills/esp-idf/SKILL.md` |
