...
def fetch_realtime_config(cli):
    ...
    try:
        ...
        try:
            ...
            local_dt_start = datetime.datetime.fromtimestamp(int(timeframe.get("start")+ 18000000 )/ 1000)
            local_dt_end = datetime.datetime.fromtimestamp(int(timeframe.get("end")+18000000) / 1000)
